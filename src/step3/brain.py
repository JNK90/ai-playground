...
# Tools
You are able to call external tools. If you need to call a tool use the explained format. After a tool has been executed the result will be included in the message in the field `tool_result`. If the field `tool_result` already exists use the value to resolve the request. 
